...
$html->PageHeader();
$html->RequirePriv("sysprog:netdb:edit-privs");
...
print "<option value=travelname>travelname - rt##owner.domain\n";
print "<option value=clcname>clcname - rc##gname.domain\n";
print "<option value=thinname>thinname - rx##gname.domain\n";
print "<option value=virtownername>virtownername - rv##owner.domain\n";
print "<option value=virtclcname>virtclcname - rcv##gname.domain\n";
print "<option value=thinclcname>thinclcname - rcx##gname.domain\n";
